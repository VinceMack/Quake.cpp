...
inline void Q_strcpy(char* dest, const char* src)
{
    std::strcpy(dest, src);
}
...
inline void Q_strncpy(char* dest, const char* src, int count)
{
    if (count <= 0) return;
...
inline void Q_strcat(char* dest, const char* src)
{
    std::strcat(dest, src);
}
...
inline int Q_strncmp(const char* s1, const char* s2, int count)
{
